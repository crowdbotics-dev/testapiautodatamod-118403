...
## Project Structure
    ...
    ├── testapiautodatamod_118403  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_118403`
...
2. Clone this repo and `cd testapiautodatamod_118403`
